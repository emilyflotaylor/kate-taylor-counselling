...
const WhatIDo: React.FC = () => {
  return (
    <div className="playfair-regular mt-48 grid grid-cols-2 w-4/5 gap-16">
      <div >
...
I understand our reactions to life’s inevitable challenges are often automatic, unconscious and unhelpful coping mechanisms, rooted in our past. What is triggered often relates to old attachment and trauma wounds.  </p>
